...
var seq__7392_7396 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__7393_7397 = null;
var count__7394_7398 = (0);
var i__7395_7399 = (0);
while(true){
if((i__7395_7399 < count__7394_7398)){
var str_7400 = cljs.core._nth.call(null,chunk__7393_7397,i__7395_7399);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7400})));
...
var temp__5753__auto___7405 = cljs.core.seq.call(null,seq__7392_7396);
if(temp__5753__auto___7405){
var seq__7392_7406__$1 = temp__5753__auto___7405;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__7392_7406__$1)){
var c__4679__auto___7407 = cljs.core.chunk_first.call(null,seq__7392_7406__$1);
var G__7408 = cljs.core.chunk_rest.call(null,seq__7392_7406__$1);
var G__7409 = c__4679__auto___7407;
var G__7410 = cljs.core.count.call(null,c__4679__auto___7407);
var G__7411 = (0);
...
var str_7412 = cljs.core.first.call(null,seq__7392_7406__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7412})));


var G__7413 = cljs.core.next.call(null,seq__7392_7406__$1);
var G__7414 = null;
var G__7415 = (0);
var G__7416 = (0);
...
var onload = (function (){
if(cljs.core.truth_((function (){var and__4251__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__7421 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__7421,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__7421,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__7421,"onreadystatechange",onload);

return G__7421;
})();
if((opt_sourceText == null)){
var G__7422 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__7422,"src",src);

return G__7422;
} else {
var G__7423 = script__$1;
goog.dom.setTextContent(G__7423,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4253__auto__ = reload;
...
var path_7424 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_7424);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7424)].join(''));
} else {
var path_7425 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_7425);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_7425);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7425)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__7426 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__7427 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__7427);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__7426);
}})()})));
}));
